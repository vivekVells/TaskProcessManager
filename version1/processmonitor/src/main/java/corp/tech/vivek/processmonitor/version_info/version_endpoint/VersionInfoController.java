...
public class VersionInfoController {
    ...
    public void addVersion(@RequestBody VersionInfoModel versionInfoModel) {
        System.out.println("post action done... " + versionInfoModel.getUsername());
        versionInfoService.addVersions(versionInfoModel);
    }
